/**
 * @summary VideoJs Overlay plugin
 *  Staywell extension of the original brightcove overlay plugin
 * 
 *  New Functionalities added: 
 *  - Cue points start/end anchors
 *  - enabled [true/false]
 *  - custom configurations by video id
 * 
 * @version 1.0.0
 * 
 * @since 1.1.4
      ...
      (function (global) {
        ...
        var plugin = function plugin(options) {
          ...
          _this2.on('loadstart', function () {
            ...
            var aptOverlays;
            if (_this2.mediainfo && _this2.mediainfo.id) {
              var videoId = _this2.mediainfo.id
              aptOverlays = overlays.filter(function (overlay) {
                return overlay.videos && overlay.videos.indexOf(videoId) !== -1;
              });
            }

            if (!aptOverlays || aptOverlays.length == 0) {
              aptOverlays = overlays.filter(function (overlay) {
                return !overlay.videos;
              });
            }

            _this2.overlays_ = aptOverlays.map(function (overlay) {
              if(overlay.hasOwnProperty("enabled") && JSON.parse(overlay.enabled) == false) {
                return;
              }
          ...
          function clear() {
            ...
            if (Array.isArray(_this2.overlays_)) {
              _this2.overlays_.forEach(function (overlay) {
